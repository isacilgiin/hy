...
export const hikaye = [
  ...
  `${foundedYear} yılından beri Denizli'deyiz. Tesisimiz Merkezefendi'de, Eskihisar Mahallesi'nde; il genelinde 19 ilçeye gidiyoruz. Çivril'e de gideriz, Çameli'ye de. Tesis Pazartesi–Cumartesi 07:00–18:00 arasında açık, alma-teslim aracı ise her gün çıkıyor — çünkü halının alınması için evde birinin bulunması gerekiyor ve bu her hanede mesai saatine denk gelmiyor. Vardiyalı çalışan bir eve akşam, hafta içi kimsenin bulunmadığı bir eve pazar günü gidilebiliyor. Uzak ilçelere çıkışı aynı bölgedeki adresleri birleştirerek planlıyoruz; yarısını alıp ikinci kez yola çıkmak kimsenin işine yaramıyor.`,
