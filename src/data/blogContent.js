...
const blogContent = {
  "beton-kesme-nasil-yapilir": {
    ...
    "giris": [
      ...
      "Beton kesme, betonarme bir elemanı parçalamadan, elmas segmentli bir diskle önceden çizilen hat boyunca ikiye ayırma işidir. Kırıcı betonu darbeyle dağıtır, kenarı düzensiz bırakır, titreşimi çevredeki betona taşır. Disk ise malzemeyi aşındırarak ilerler ve geriye düz, tanımlı bir kenar kalır. Kapı ile pencere boşlukları tam olarak bu farkın işe yaradığı yerdir, çünkü açıklık açıldıktan sonra geriye kalan duvarın sağlam bir kenara sahip olması gerekir.",
    ...
    "bolumler": [
      {
        ...
        "paragraflar": [
          ...
          "İşin düzgün çıkmasını sağlayan asıl unsur makinenin gücü değil, üzerinde yürüdüğü ray. Testere, duvara dübellenen bir kızak üzerine oturur ve hat boyunca motorla ilerler. Serbest elle yapılan kesimlerde disk donatıya girdiği anda hattan kaçar, yüzeyde dalgalanma bırakır; rayda böyle bir sapma olmaz, kesim baştan sona aynı çizgide kalır. Tek yüzden inilebilen derinlik disk çapının yarısından biraz azdır, çünkü diskin göbeği ve flanşı duvarın içine girmez. Kalın kesitlerde aynı hat karşı yüzden ikinci kez kesilir.",
          "Disk tek hamlede tam derinliğe dalmaz. Her geçişte birkaç santim daha inerek hat boyunca gider gelir. Böylece motorun yükü dengede kalır, donatıya girildiğinde disk hattan sapmaz. Kullandığımız sistemle 600 mm derinliğe kadar kesim yapılabiliyor. Kesim boyunca hatta su verilir: su segmenti soğutur, artığı dışarı taşır, tozu daha havaya kalkmadan bastırır."
        ]
      },
      {
      ...
      },
      {
        ...
        "paragraflar": [
          ...
          "Bu suyun bir bedeli var: kesim çamuru. Su ile beton unu karışınca akıcı, gri ve yapışkan bir artık çıkar, kuruduğunda sertleşir. Parke ve laminatın altına girerse zemin şişer, mermer ile derz lekelenir, gidere verilirse tesisat tıkanır. Bu yüzden çalışma alanı örtülür, kesim hattının altına toplama seti veya kanal çekilir, biriken su ıslak vakumla beklemeden alınır. Kat aralarındaki döşeme kesimlerinde ayrıca alt kata sızıntı riski vardır; suyun aşağı geçebileceği her boşluk kesimden önce kapatılır. Kesim çamuru ve beton parçaları iş bitiminde sahadan çıkarılır."
        ]
      },
      {
        "baslik": "Lento, Parçanın Ağırlığı ve İndirilmesi",
        "paragraflar": [
          "Açıklığın üstünde kalan duvarın ağırlığı bir yere aktarılmak zorunda. Mevcut kapı boşluklarında bu işi lento yapar. Yeni açılan bir boşlukta üstte taşıyıcı bir kiriş yoksa lento yapılması gerekir; genişletilen boşluklarda ise mevcut lentonun yeni açıklığa yetmemesi sık karşılaşılan bir durumdur, çünkü lento iki yandaki oturma payıyla birlikte hesaplanır. Dolgu duvarda bile lentonun boyutu keyfî seçilmez. Çözüm taşıyıcı sisteme bağlanacaksa iş yine mühendis onayına döner.",
          ...
          "İndirme sırası da kesim planının parçasıdır. Panel son geçişe girmeden önce askıya alınır ya da tabandan takozlanır, parçayı asılı tutan kenar en sona bırakılır. Serbest kalan panel kontrollü şekilde yatırılır, gerekirse yerinde bölünüp taşınır. Sahada en sık görülen hata, son geçiş bittikten sonra parçanın kendi kendine yerinde duracağını varsaymak. Yalnızca sürtünmeyle duran bir panel en küçük titreşimde devrilir. Aynı hesap desteğin kendisi için de geçerli: taşıma kapasitesi parçanın ağırlığını karşılamayan bir destek yalnızca güven duygusu verir."
        ]
      },
      {
        "baslik": "Kırıcıyla Açmak Yerine Kesim: Fark Nerede",
        "paragraflar": [
          "Kırıcı darbeyle çalışır ve her darbe betonun içine bir basınç dalgası gönderir. Bu dalga kırılan yerde durmaz, çevreye yayılır. Açıklığın kenarında kalması gereken betonda gözle görülmeyen çatlaklar, donatı çevresinde aderans kaybı bırakır. Kesimde ise kuvvet darbe değil aşındırmadır, komşu betona iletilen titreşim çok daha düşüktür. Bitmiş bir yapıda bu farkı aramak gerekmez, kendini gösterir: alt katın tavan sıvası, duvardaki fayanslar ve cam, kırıcıyla açılan boşluklarda kesimle açılanlara göre çok daha fazla zorlanır.",
          "Toz ve gürültü tarafı da aynı yöne çıkıyor. Kırıcı kuru toz üretir ve o toz dairenin her yerine dağılır; sulu kesimde toz kaynağında tutulduğu için yayılan artık, çevresi kapatılmış bir alandaki çamurdan ibaret kalır. Gürültü kırıcıda darbe kaynaklıdır ve saatlerce sürer, oturulan bir binada komşu tarafındaki karşılığı bu yüzden farklı olur. Kesimde ilerleme hat boyunca öngörülebilir, işin ne kadar süreceği baştan söylenebilir.",
          "Kesim sonrası yüzey işi burada tamamlıyor. Kırılarak açılan bir boşluğun kenarı tırtıklıdır, donatı uçları dışarı çıkar ve kasa oturtmadan önce kenar düzeltme, dolgu ve sıva gerekir. Kesim yüzeyi diskin bıraktığı düz bir yüzeydir, çoğu işte doğrudan kasa veya doğrama oturtulabilir. Yine de ray dübel deliklerinde ve köşe tamamlamalarında iz kalır, ince bir rötuş gerekir. Kırıcının da kendi yeri var: hafif bölme duvarlarda ve kesilen parçanın yerinde ufalanması gereken durumlarda kullanılıyor. Çoğu işte ikisi birlikte çalışıyor, hat testereyle kesilip iç kısım kırıcıyla alınıyor."
        ]
      }
    ],
    "sss": [
  ...
  "karot-mu-kirici-mi": {
    ...
    "giris": [
      ...
      "Karar aslında birkaç sorunun cevabında saklı. Deliğin ölçüsü tutmak zorunda mı, çevredeki beton darbe kaldırır mı, binada oturan ya da çalışan var mı, donatının nerede geçtiğini biliyor muyuz, iş bitince sıva ve tamir masrafı çıkacak mı. Aşağıda bunları tek tek açıyorum. Denizli merkez ve ilçelerde on bir yılı aşkın süredir yaptığımız işlerde bu sorular hemen her keşifte aynı sırayla önümüze geliyor."
    ],
    "bolumler": [
      {
        "baslik": "Önce şunu sorun: delik gerçekten ölçülü olmak zorunda mı?",
        "paragraflar": [
          "Karot dediğimiz şey elmas uçlu silindirik bir uç. Beton içinde dönerek kendi çapında bir silindir çıkarıyor. Ø32'den başlayıp Ø350 ve üstüne kadar çap var. Çıkan delik nominal çapında olur, kenarı düzdür, içi pürüzsüzdür. Yani Ø102 dediyseniz Ø102 alırsınız, iki santim oynamaz.",
  ...
  "karot-nedir": {
    ...
    "giris": [
      "Karot, sahada iki ayrı şeyin adı. Biri yöntem: elmas uçlu silindirik bir uçla betonda dairesel ve düzgün bir delik açmak. Diğeri o işlemden çıkan parça, yani elemanın içinden bütün hâlde alınan beton silindiri. Telefonda karot lazım diyen kişi çoğunlukla birincisini kastediyor, duvardan ya da döşemeden bir geçiş deliği istiyor. Bazen de ikincisini kastediyor ve binanın betonunun gerçekte ne dayanım verdiğini öğrenmek istiyor. İki iş aynı makineyle yapılır ama hazırlığı, seçilen çap ve delik açıldıktan sonra yapılacaklar birbirinden farklıdır.",
      "Kelime Fransızcadan geliyor, havuç anlamındaki carotte'tan. Sondajda yerin altından çıkarılan uzun ve ince silindir parçaya benzetme yoluyla verilmiş bir ad, oradan beton işlerine geçmiş. Karotçu dendiğinde ise bu işi yapan kişi anlaşılıyor: makineyi kuran, sabitleyen, deliği ekseninde tutan, gerektiğinde numuneyi sağlam çıkaran usta. Karotçu laboratuvar değildir. Numuneyi alır, dayanım değerini veren taraf deneyi yapan laboratuvardır.",
    ...
    "bolumler": [
      {
        ...
        "paragraflar": [
          ...
          "Sahada bu iki iş sık sık birbirine karıştığı için işe başlamadan üç soru soruyoruz. Delikten ne geçecek, yoksa bir rapor mu isteniyor? Delinecek eleman taşıyıcı mı, bölme duvar mı? Delik açıldıktan sonra kapatılacak mı, açık mı kalacak? Bu üç cevap hem çapı hem kurulumu hem de sahada geçecek süreyi baştan belirliyor."
        ]
      },
      {
        "baslik": "Elmas Uç Betonu Keserek İlerler, Kırarak Değil",
        "paragraflar": [
          "Karot ucu, silindirik bir boru gövdenin ucuna dizilmiş segmentlerden oluşur. Segmentlerin içinde metal bir bağ malzemesine gömülmüş sentetik elmas taneleri vardır. Uç dönerken bu taneler betonu ve içindeki agregayı aşındırarak öğütür. Bağ malzemesi de aşındıkça körelmiş tanenin altından yenisi açığa çıkar, yani uç çalışırken bir yandan kendini bileyerek gider. Kesici, malzemenin yalnızca halka biçimindeki dar bir şeridini tüketir; ortada kalan silindire hiç dokunmaz ve o parça bütün hâlde dışarı çıkar.",
      ...
      },
      {
        ...
        "paragraflar": [
          "Karot, deliğin çapının belli olması, kenarının düzgün kalması ve çevresine zarar verilmemesi gereken işlerin yöntemidir. Betonarme bir döşemeden ya da perdeden geçiş açılacaksa, malzemenin içinde donatı varsa, mekân bitmiş ve teslim edilmişse pratikte başka bir yolu yoktur. Kesim ve kırım işlerinde de yardımcı rol oynar: elmas diskin bitiremediği iç köşelere başlangıç deliği açmak ya da tel kesimde telin geçeceği giriş deliklerini hazırlamak karotun işidir.",
          "Bunun dışında kalan işlerde makineyi kurmanın anlamı yok. Sekiz on milimetrelik bir dübel deliği için karot kurulmaz, o iş darbeli matkabındır. Tamamen yıkılacak bir bölme duvarda kaba bir açıklık isteniyorsa kırıcı hem daha hızlı hem daha ucuz kalır, çünkü kenarın düzgünlüğünün kimseye faydası olmayacaktır. Alçıpan ve ahşap gibi hafif malzemelerde de panç yeterlidir.",
          "Karotun asıl maliyeti delme süresi değil, kurulum süresidir. Sehpayı sabitlemek, su düzenini kurmak, örtüleri sermek zaman ister. Tek bir küçük delik için bu hazırlık ağır gelebilir, ama aynı sahada beş on delik varsa hesap tersine döner ve delik başına düşen süre hızla azalır. Bu yüzden keşifte delik adedini, çapları ve çalışılacak katları birlikte çıkarıyoruz. Özetlemek gerekirse karot şu işlerde tercih ediliyor:"
        ],
        "liste": [
      ...
      },
      {
        ...
        "paragraflar": [
          "Çapı belirleyen şey, içinden geçecek elemanın dış ölçüsüne yalıtım ve montaj payının eklenmesidir. Buradaki yaygın hata cömert davranmaktır. Gereğinden büyük bir delik hem elemandan gereksiz kesit götürür hem de sonradan yapılacak dolgu ve yangın durdurucu kapatma işini zorlaştırır. Karot uçları yaklaşık 20 mm ile 600 mm arasında üretiliyor, ama işlerin büyük kısmı bundan çok daha dar bir aralıkta dönüyor.",
          "Derinliği sınırlayan şey ise ucun boyudur. Standart uçlar çoğunlukla 40-50 cm civarında iş görür; bir döşemeyi ya da normal kalınlıktaki bir perdeyi tek seferde geçerler. Daha kalın kesitlerde araya uzatma parçası girer ve delik kademe kademe derinleştirilir. Uzun kurulumda esneme payı büyüdüğü için sehpa daha sıkı bağlanır, ilerleme düşürülür ve su akışı hiç kesilmez.",
          "Bir metreyi aşan kesitlerde uzatma her zaman çare olmaz; böyle durumlarda elemana iki yüzünden ayrı ayrı girilir. Bunun tek şartı var: iki deliğin ekseni ortada buluşmalı. Birkaç derecelik açı hatası kalın bir kesitin öbür yüzünde epeyce sapma demektir, hatlar kaçarsa geçiş tam açılmaz. Çapın büyümesi de sadece daha büyük bir delik anlamına gelmez; gereken tork, ucun ürettiği tepki ve sehpaya binen yük birlikte artar, küçük çapta iş gören vakum tabanı büyük çapta yetmez ve dübelli plakaya geçilir. Sahada en sık karşımıza çıkan çaplar şu aralıklarda toplanıyor:"
        ],
        "liste": [
      ...
      },
      {
        ...
        "paragraflar": [
          ...
          "Onay geldikten sonra da hazırlık bitmiş sayılmaz. Delik yeri projedeki konuma göre işaretlenir, donatı taramasıyla teyit edilir ve imkân varsa birkaç santim kaydırılarak demirin arasından geçilmeye çalışılır. Çoğu zaman aynı geçiş bölme duvardan ya da döşemenin başka bir noktasından da çözülebiliyor. Öyle bir alternatif varsa keşifte onu söylemek işin bir parçası."
        ]
      },
      {
        "baslik": "Karot Numunesi ve Beton Dayanım Testi",
        "paragraflar": [
          "Mevcut bir yapının betonunun gerçekte ne dayanım verdiğini öğrenmenin en doğrudan yolu, yapının kendisinden bir parça almaktır. Güçlendirme projelerinde, riskli yapı değerlendirmelerinde, dönüşüm sürecinde ya da dökülen betonla ilgili şüphe doğduğu durumlarda bu numune isteniyor. Yüzeyden yapılan çekiç ölçümleri fikir verir ama tek başına yeterli sayılmaz; değerlendirmenin dayandığı sayı, çıkarılan silindirin laboratuvarda kırılmasıyla bulunur.",
          "Numunenin nereden alınacağı karotçunun kararı değildir. Hangi kat, hangi eleman, elemanın hangi bölgesi sorusunu yapının mühendisi cevaplar; rastgele seçilmiş bir nokta hem raporu tartışmalı hâle getirir hem elemana gereksiz zarar verir. Alma işinde üç şeye dikkat edilir. Numune yüzeye dik alınır. İçinden donatı geçmemelidir, o yüzden delmeden önce tarama yapılır; demir içeren bir silindir betonu temsil etmez. Çapı seçerken beton içindeki en iri agrega tanesi gözetilir; yeterince kalın olmayan bir silindirde denk gelen tek bir iri tane bile sonucu kaydırabilir.",
          "Boy ve çap oranı da serbest değildir, bu oran raporlanan dayanım değerini doğrudan etkiler. Kısa kalan bir numune sonradan telafi edilemez, o eleman ikinci kez delinir. Silindir kırılmadan, alındığı yer ve yön üzerine yazılarak teslim edilir. Geriye kalan boşluk uygun tamir harcıyla doldurulur; bu adım atlanırsa bilgi almak uğruna açılmış bir zayıf nokta yapının içinde öylece kalır. Numune sayısı da mühendisin programına bağlıdır, tek bir silindirden bütün bina hakkında hüküm çıkmaz."
        ]
      }
    ],
    "sss": [
      {
        ...
        "a": "Darbeli matkap ucu döndürürken bir yandan da vurur, malzemeyi ezerek ve çatlatarak ilerler. Karot ucu vurmaz, yalnızca döner ve elmas segmentlerle aşındırarak keser. Ortaya çıkan delikte fark bellidir: karot deliğinin kenarı düzgündür, çevresinde çatlama olmaz, karşı yüzdeki kaplama patlamaz. Buna karşılık küçük çaplı basit deliklerde darbeli matkap çok daha pratiktir; karot, çapın ve kenarın önemli olduğu işler için vardır."
      },
      {
