...
const serviceContent = {
  ...
  'hidrolik-beton-kesme': {
    ...
    detaylar: [
      ...
      {
        baslik: 'Elektriksiz Sahalar ve Su Altı Kesim',
        metin: 'Dizel motorlu güç ünitesi kendi yakıtıyla çalıştığı için şantiye elektriğine bağlı değildir. Kablo çekilemeyen köprü altlarında, kırsaldaki sulama yapılarında ve henüz enerji verilmemiş tesislerde iş bu sayede yürür. Asıl sınır ünite değil, hortum boyudur; başlığın gidebileceği mesafe hortumla sınırlı olduğundan ünitenin nereye konacağı keşifte belirlenir. Basınç altındaki hortum hattına çalışma sırasında dokunulmaz, kaçak görülürse sistem durdurulup basınç alınır. Kapalı hacimlerde dizel ünitenin egzozu ciddiye alınması gereken bir konudur; ya dışarı alınır ya da elektrikli üniteye geçilir. Su altında ise hidroliğin belirgin bir üstünlüğü var: kesim başlığında elektrik bulunmadığı için iskele, savak ve rıhtım yapılarında dalgıç ekiple çalışılabiliyor.',
      },
    ],
    sss: [
      {
      ...
      {
        q: 'Su altında kesim için suyu boşaltmak gerekiyor mu?',
        a: 'Gerekmiyor; hidrolik sistemin su altında çalışabilmesinin sebebi zaten bu. Kesim başlığında elektrik olmadığından su tahliyesi ve kuru ortam hazırlığı ortadan kalkıyor. Çalışma dalgıç ekiple yürütülüyor ve görüş kısıtlı olduğu için kesim hattı, askı noktaları ve haberleşme düzeni suya girilmeden karada belirleniyor. Blok su içinde hafif gelir ama yüzeye çıkarken tüm ağırlığı vince biner; hesap ona göre yapılır.',
      },
    ],
  },
  'filiz-ekimi': {
